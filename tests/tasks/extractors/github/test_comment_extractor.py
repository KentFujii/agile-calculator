...
class TestCommentExtractor:
    ...
    def test_run_returns_comment_records(self, mocker, mock_github_client):
    ...
    def test_run_filters_by_users(self, mocker, mock_github_client):
    ...
    def test_run_handles_no_pull_requests(self, mocker, mock_github_client):
    ...
    def test_run_handles_no_comments(self, mocker, mock_github_client):
